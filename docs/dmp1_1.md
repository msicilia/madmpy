...
!!! warning
    This API is based on an old version of the [RDA-DMP Common Standard](https://github.com/RDA-DMP-Common/RDA-DMP-Common-Standard/releases/tag/v1.1/). Read the latest API reference version of this documentation.
